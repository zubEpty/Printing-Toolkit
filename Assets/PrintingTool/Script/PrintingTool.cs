...
public class PrintingTool : MonoBehaviour
{
    ...
    public List<string> available_printers;
    ...
    private void Start()
    {
        CmdPrint("wmic printer get name");
        print("Printer name  is " + output);
        
        dropDown.options.Clear();
        foreach (var item in available_printers)
        {
    ...
    void DropDownItemSelected(TMP_Dropdown dropdown)
    {
        ...
        printerName = dropDown.options[index].text;
    }
    ...
    void CmdPrint(string _command)
    {
        try
        {
           ...
           // myProcess.StartInfo.WindowStyle = ProcessWindowStyle.Hidden;
            ...
            available_printers = output.Split(new string[] { Environment.NewLine },StringSplitOptions.RemoveEmptyEntries)
                .Select(i => i.Trim())
                .Where(i => i.Length > 0 && i != "Name").ToList();
